...
const SectionCategory = () => {
  return (
    <section className="section-with-pb rounded-md flex flex-col gap-16 md:gap-40 antialiased bg-black dark:bg-black dark:bg-grid-white/[0.05] items-center justify-center relative overflow-hidden">
      ...
      {/* grid justify-items-center grid-cols-2 sm:grid-cols-3 lg:grid-cols-3 gap-10 */}
      <CategoryContainer />
    </section>
  );
};
...
const CategoryCard = ({
  ...
  return (
    <li className="w-[350px] max-w-full h-[18rem] relative overflow-hidden rounded-2xl border border-b-0 flex-shrink-0 border-black md:w-[450px] fbrand-shadow">
      <div
        aria-hidden="true"
      ...
      />
      <div className="w-full absolute flex flex-col justify-center items-center gap-10 top-1/3 fright-40">
        <div>
