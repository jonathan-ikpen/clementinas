...
const SectionCustomerReviews = () => {
  const reviews = [
    ...
    // {
    //   testimonial:
    //     "Which one be buy for another place? <br> If nor be you I nor dey trust people for money matter that's cos i believe you 💯 <br> Ok make i calculate my self, monday i will send you the amount am buying",
    //   name: "Cus",
